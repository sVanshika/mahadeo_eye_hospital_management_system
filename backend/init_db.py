#!/usr/bin/env python3
"""
Database initialization script for Eye Hospital Patient Management System
"""
...
from database import Base, User, Room, UserRole
...
if __name__ == "__main__":
    print("Eye Hospital Database Initialization")
    print("=" * 40)
    init_database()
